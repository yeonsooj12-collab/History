...
const widgetUri = "ui://widget/history-lens-v0.5.4.html";
...
function createHistoryLensServer() {
  const server = new McpServer(
    { name: "history-lens", version: "0.5.4" },
    {
      instructions:
...
const httpServer = createServer(async (req, res) => {
  ...
  if (req.method === "GET" && url.pathname === "/") {
    ...
    return res.end(JSON.stringify({ name: "history-lens", version: "0.5.4", widgetUri, status: "ok", mcp: mcpPath }));
  }
